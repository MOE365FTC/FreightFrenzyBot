...
public class DriveSideLeft {
    ...
    public DriveSideLeft(DcMotor front, DcMotor back, Servo odoServo, boolean frontMotorReverse, boolean backMotorReverse, double odoUpPos, double odoDownPos, double ticsPerInch, double backwardTicsPerInch) {
        this.front = front;
        this.back = back;
