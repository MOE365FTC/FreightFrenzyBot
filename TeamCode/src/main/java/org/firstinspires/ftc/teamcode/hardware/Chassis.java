...
public class Chassis {
    ...
    public void turnToHeading(double targetHeading, TurnDirection dir, double turnPower, double tolerance){
        ...
        double heading = (motorFrontLeft.getCurrentPosition() - motorFrontRight.getCurrentPosition()) * rotateScalar;
        ...
        while (error > tolerance && this.opMode.opModeIsActive()){
            heading = (motorFrontLeft.getCurrentPosition() - motorFrontRight.getCurrentPosition()) * rotateScalar;
