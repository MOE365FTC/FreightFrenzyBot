 ...
 */
@Config
public class SixWheelDrive extends TankDrive {
    ...
    private DcMotorEx leftFront, leftMiddle, leftRear, rightRear, rightMiddle, rightFront;
    private List<DcMotorEx> motors, leftMotors, rightMotors;
    private BNO055IMU imu;

    private VoltageSensor batteryVoltageSensor;

    public SixWheelDrive(HardwareMap hardwareMap) {
