...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 0.7166825435; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 13.73189; // in
     ...
     * inches.
     */
    public static double MAX_VEL = 49.191;
    public static double MAX_ACCEL = 49.191;
